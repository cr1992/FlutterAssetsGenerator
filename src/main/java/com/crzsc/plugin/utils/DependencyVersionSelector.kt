...
/** 依赖版本选择器 根据 Flutter SDK 版本选择兼容的依赖版本 */
object DependencyVersionSelector {
    ...
    fun getFlutterSvgVersion(flutterVersion: SemanticVersion?): String {
        if (flutterVersion == null) {
            LOG.info(
                "[FlutterAssetsGenerator #DependencyVersionSelector] No Flutter version, using conservative flutter_svg version"
            )
        ...
        LOG.info(
            "[FlutterAssetsGenerator #DependencyVersionSelector] Flutter $flutterVersion -> flutter_svg $version"
        )
        return version
    }
    ...
    fun getLottieVersion(flutterVersion: SemanticVersion?): String {
        if (flutterVersion == null) {
            LOG.info(
                "[FlutterAssetsGenerator #DependencyVersionSelector] No Flutter version, using conservative lottie version"
            )
        ...
        LOG.info(
            "[FlutterAssetsGenerator #DependencyVersionSelector] Flutter $flutterVersion -> lottie $version"
        )
        return version
    }
     ...
     * 获取推荐的 rive 版本
     * @param flutterVersion Flutter SDK 版本,如果为 null 则返回保守版本
     * @return 版本约束字符串,例如 "^0.13.4"
     */
    fun getRiveVersion(flutterVersion: SemanticVersion?): String {
        if (flutterVersion == null) {
            LOG.info(
                "[FlutterAssetsGenerator #DependencyVersionSelector] No Flutter version, using conservative rive version"
            )
            return "^0.13.20" // 保守策略
        }
        ...
        val version =
            when {
                // Flutter >= 3.0.0: 使用 0.13.x 系列
                flutterVersion >= SemanticVersion(3, 0, 0) -> "^0.13.20"
        ...
        LOG.info(
            "[FlutterAssetsGenerator #DependencyVersionSelector] Flutter $flutterVersion -> rive $version"
        )
        return version
    }
}
