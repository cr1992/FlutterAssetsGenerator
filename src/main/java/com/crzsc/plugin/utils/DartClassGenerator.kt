...
class DartClassGenerator(
    ...
    private fun generateRobust(): String {
        LOG.info("[FlutterAssetsGenerator #DartClassGenerator] [DartClassGenerator] Starting robust code generation...")
    ...
    private fun generateLegacy(): String {
        LOG.info("[FlutterAssetsGenerator #DartClassGenerator] Starting legacy code generation (camel_case)...")
        buffer.append("///This file is automatically generated. DO NOT EDIT, all your changes would be lost.\n")
        val className = FileHelperNew.getGeneratedClassName(config)
    ...
    private fun generateNodeFields(node: AssetNode, prefix: String, isRoot: Boolean) {
        ...
        val sortedChildren =
            nodesToProcess.sortedWith(compareBy({ it.type == MediaType.DIRECTORY }, { it.name }))
